...
export const query = graphql`
  query {
    hero: file(relativePath: { eq: "hero.jpg" }, children: {}) {
      relativePath
      childImageSharp {
        fluid(maxWidth: 1600) {
    ...
    fruit: file(relativePath: { eq: "fruit.jpg" }, children: {}) {
      relativePath
      childImageSharp {
        fluid(maxWidth: 320) {
          ...GatsbyImageSharpFluid_withWebp
    ...
    grain: file(relativePath: { eq: "grain.jpg" }, children: {}) {
      relativePath
      childImageSharp {
        fluid(maxWidth: 320) {
          ...GatsbyImageSharpFluid_withWebp
    ...
    beverage: file(relativePath: { eq: "beverage.jpg" }, children: {}) {
      relativePath
      childImageSharp {
        fluid(maxWidth: 320) {
          ...GatsbyImageSharpFluid_withWebp
    ...
    berry: file(relativePath: { eq: "berry.jpg" }, children: {}) {
      relativePath
      childImageSharp {
        fluid(maxWidth: 1600) {
          ...GatsbyImageSharpFluid_withWebp
